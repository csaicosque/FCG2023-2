...
public:
	...
	inline void setPosition(glm::vec3 position) { this->shader->Use(); this->position = position; }
	...
	inline int getWidth() { return dimensions.x; }
	inline int getHeight() { return dimensions.y; }
